...
function problemA() {
	...
	// promise version
	// ???
	promisifiedReadFile('poem-one/stanza-01.txt').then((res) => blue(res));
}
...
function problemB() {
	...
	promisifiedReadFile('poem-one/stanza-02.txt').then((res) => blue(res));
	promisifiedReadFile('poem-one/stanza-03.txt').then((res) => blue(res));
}
...
function problemE() {
	...
	// 	blue(stanza3);
	// 	readFile('poem-one/stanza-04.txt', function (err2, stanza4) {
