...
async function asyncStanzaPromise(param) {
...
async function problemA() {
	...
	await Promise.all([
		asyncStanzaPromise('poem-two/stanza-01.txt'),
		asyncStanzaPromise('poem-two/stanza-02.txt'),
	]);
...
async function problemB() {
	...
	const arrayOfPromises = filenames.map((file) => asyncStanzaPromise(file));
